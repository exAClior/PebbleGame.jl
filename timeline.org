...
The first paper that proposes the use of a reversible pebble game is
[[cite:&meuliReversiblePebblingGame2019]]. Motivation, why previous methods failed? Method? Outstanding question?
